...
$string['allowedbrowserkeys'] = 'Allowed configuration keys';
$string['allowedbrowserkeys_help'] = 'In this box you can enter the allowed configuration keys for versions of Safe Exam Browser that are permitted to access this quiz. If no keys are entered, then no specific configuration key is required for this quiz.';
